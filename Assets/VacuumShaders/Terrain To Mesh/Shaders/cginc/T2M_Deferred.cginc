...
#endif
{
	...
	mainTex.rgb *= _Color.rgb;
		...
		#ifdef V_T2M_2_CONTROL_MAPS
			#ifdef V_T2M_5_TEX
				metallic += splat_control2.a * _V_T2M_Splat5_Metallic;
			#endif
			#ifdef V_T2M_6_TEX
				metallic += splat_control2.a * _V_T2M_Splat6_Metallic;
			#endif
			#ifdef V_T2M_7_TEX
				metallic += splat_control2.a * _V_T2M_Splat7_Metallic;
			#endif
			#ifdef V_T2M_8_TEX
		...
		#ifdef V_T2M_2_CONTROL_MAPS
			#ifdef V_T2M_5_TEX
				glossiness += splat_control2.a * _V_T2M_Splat5_Glossiness;
			#endif
			#ifdef V_T2M_6_TEX
				glossiness += splat_control2.a * _V_T2M_Splat6_Glossiness;
			#endif
			#ifdef V_T2M_7_TEX
				glossiness += splat_control2.a * _V_T2M_Splat7_Glossiness;
			#endif
			#ifdef V_T2M_8_TEX
