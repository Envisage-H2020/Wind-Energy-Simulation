...
public class TurbineSpawnManager : MonoBehaviour {
    ...
    public void SpawnTurbine(){
		...
		if(numberOfTurbines <5){ // the first row of turbines.
			spawnPointUp.position = new Vector3(spawnPointUp.position.x + 40, spawnPointUp.position.y, spawnPointUp.position.z); 
			...
			spawnPointDown.position = new Vector3(spawnPointDown.position.x + 39, spawnPointDown.position.y, spawnPointDown.position.z);
